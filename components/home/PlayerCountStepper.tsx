  ...
  return (
    <View className="flex-row items-center gap-4">
      <Pressable
        ...
        className="w-16 h-16 rounded-2xl bg-gray-200 dark:bg-gray-700 items-center justify-center active:opacity-80"
      ...
      <TextInput
        ...
        className="flex-1 h-16 rounded-2xl bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-black dark:text-white text-center text-xl font-bold"
        selectTextOnFocus
        maxLength={2}
      />
      <Pressable
